                                        ...
                                        table-responsive-lg" id="patients">
                                            ...
                                            @foreach($patients as $row)
                                                <tr>
                                                    ...
                                                    <td>{{$row->Email}}</td>
                                                    <td><a alt="Edit" href="{{ route('patients.edit', $row->id)}}"><i class="far fa-edit"></i></a>
                                                        @if(!isset($row->calculator->last()->activeness))
                                                            <a alt="Report" href="{{ url('/calculator/'.$row->id) }}" style="color: #00b248;"><i class="fas fa-calculator"></i></a>
                                                        @else
