...
class CalculatorController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $this -> validate($request, [
            ...
            'waist' => 'required|numeric|between:0,99.99',
            'hip' => 'required|numeric|between:0,99.99',
            'wh_ratio' => '',
            'wh_class' => '',
            ...
            'copper'=> 'required',
            'zinc'=> 'required',
            'bilirubin_total'=> 'required',
            'bilirubin_conj'=> 'required',
            'bilirubin_unconj'=> 'required',
            'ast'=> 'required',
            'alt'=> 'required',
            'ldh'=> 'required',
            'ggt'=> 'required',
            ...
            'copper_class'=> '',
            'zinc_class'=> '',
            'bilirubin_total_class'=> '',
            'bilirubin_conj_class'=> '',
            'bilirubin_unconj_class'=> '',
            'ast_class'=> '',
            'alt_class'=> '',
            'ldh_class'=> '',
            'ggt_class'=> '',
